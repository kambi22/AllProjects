                ...
                <Card className=" MuuliColorCard rounded-5 shadow">
                    ...
                    <CardContent>
                        <div className="Cardstyle  mt-5 mb-5 ">
                            ...
                            <TextField className="w-100 mt-3 ellipsedText" label='Id' placeholder="Enter transaction id  " type="number" id="id" name="id" onChange={(e) => setId(e.target.value)} required />

                            <TextField className="w-100 mt-3 ellipsedText" label='Amount' placeholder="Enter bid amount" type="number" id="amount" name="amount" value={amount} onChange={(e) => setAmount(e.target.value)} />
                            <br /><br />
                            <div className="d-flex justify-content-between mt-3">
                                <Button className="bg-info w-100 me-2" variant="contained" onClick={submitTx}>Submit</Button>
                                ...
                                <Button className="bg-warning w-100 me-2" variant="contained" onClick={ConfirmTx}>Confirm</Button>
                                <Button className="bg-success w-100" variant="contained" onClick={ExecutedTX}>Executed</Button>
                            </div>
                            <Button className="bg-secondary w-100 mt-3" variant="contained" onClick={resentWallet}>Reset wallet</Button>
